...
const Header = () => {
  ...
  const [user, setUser] = useState({ name: "User", role: "Role", avatar: "assets/img/profiles/avator1.jpg" });
    ...
    if (storedUser) {
      try {
        ...
        setUser({
          ...
          role: userData.role === "superadmin" ? "Super Admin" : (userData.role === "admin" ? "Admin" : "Cashier"),
          avatar: userData.avatar || "assets/img/profiles/avator1.jpg"
        });
      } catch (error) {
  ...
  const handleLogout = () => {
    ...
    // Reset header Authorization pada instance API
    delete API.defaults.headers.common["Authorization"];
    // Redirect ke halaman login
    navigate("/signin");
  };

  // === Fungsi-fungsi yang sudah ada (tidak perlu diubah) ===
      ...
      <div className="header">
        ...
        >
          ...
          <Link to="/dashboard" className="logo-small">
            <ImageWithBasePath src="assets/img/logoamcsmall.png" alt="img" />
          </Link>
          <Link
            id="toggle_btn"
            to="#"
              ...
              <div className="profilename">
                <div className="profileset">
                  <span className="user-img">
                    <ImageWithBasePath src={user.avatar} alt="img" />
